...
public class ReactCircularSeekBar extends View {
	...
	protected void initAttributes() {
		...
		mPointerHaloWidth = DEFAULT_POINTER_HALO_WIDTH * DPTOPX_SCALE;
		mPointerHaloBorderWidth = DEFAULT_POINTER_HALO_BORDER_WIDTH * DPTOPX_SCALE;
		mCircleStrokeWidth = DEFAULT_CIRCLE_STROKE_WIDTH * DPTOPX_SCALE;
